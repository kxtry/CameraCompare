...
/**
 * 相机辅助类，和{@link Camera1Listener}共同使用，获取nv21数据等操作
 */
    ...
    private Camera.Size getBestSupportedSize(List<Camera.Size> sizes, Point previewViewSize) {
        ...
        Arrays.sort(tempSizes, new Comparator<Camera.Size>() {
            ...
            public int compare(Camera.Size o1, Camera.Size o2) {
                int v1 = o1.width * o1.height;
                int v2 = o2.width * o2.height;
                if(v1 == v2) {
                    return o1.width > o2.width ? 0 : 1;
                }
                return v1 < v2 ? 0 : 1;
            }
        });
        ...
        for(int i = 0; i < sizes.size(); i++) {
            if(sizes.get(i).width >= 600 && sizes.get(i).height >= 400) {
                return sizes.get(i);
            }
        }
        return sizes.get(0);
